...
public class IdpEndpoint {
    ...
    public void authorized(HttpServletRequest request
        ...
        HTTPRedirectDeflateEncoder httpRedirectDeflateDecoder = new HTTPRedirectDeflateEncoder();

        httpRedirectDeflateDecoder.setMessageContext(context);
        httpRedirectDeflateDecoder.setHttpServletResponse(response);
        ...
        try {
            ...
            httpRedirectDeflateDecoder.encode();
